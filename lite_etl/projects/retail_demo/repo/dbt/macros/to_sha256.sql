{#
  One hashing expression, three warehouses. This is the kind of thin seam that
  lets the same models run on DuckDB, Databricks or Snowflake unchanged.
#}
{% macro to_sha256(col) -%}
    {{ return(adapter.dispatch('to_sha256', 'retail_demo')(col)) }}
{%- endmacro %}
