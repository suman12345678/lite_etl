...
4. Write to `<WS>/design/`: `architecture-overview.md`, `architecture-diagram.md`,
   ...
   `pipeline-blueprint.md`, `design-decisions.md`, `traceability-matrix.md`,
   `README.md`. Diagrams as Mermaid. Templates come from the harness
   `design/templates/`.
5. Walk me through the approach, diagrams and key decisions; revise on feedback.
6. Update `<WS>/progress.json`.
